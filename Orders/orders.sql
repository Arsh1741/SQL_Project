select * from orders;
alter table orders drop column MyUnknownColumn;
...
-- find month over month comparison for 2022 and 2023 sales eg: jan 2022 vc jan 2023
with cte as (
...
select *,
(sales_2023-sales_2022)*100/sales_2022 as percent_growth
from cte2
